<div class="header bg-light b-b b-light text-right">
	<div class="btn-group">
		...
		<?php echo $this->Html->link(__('Company Info List'), array('action' => 'index'),array('class' => 'btn btn-sm btn-default ajax_page')); ?>
	</div>
</div>
<!-- Panel -->
<div class="widget">
	...
	<div class="widget-content">
		<?php echo $this->Form->create('CompanyInfo',array('role'=>'form','class'=>'')); ?>
		<?php
