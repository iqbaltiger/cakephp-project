<div class="header bg-light b-b b-light text-right">
	<div class="btn-group">
		...
		<?php echo $this->Html->link(__('Employee List'), array('action' => 'index'),array('class' => 'btn btn-sm btn-default ajax_page')); ?>
	</div>
</div>
<!-- Panel -->
<div class="widget">
...
//			echo $this->Form->input('user_id',array('class'=>'form-control','div'=>'form-group'));
			...
			echo $this->Form->input('last_name',array('class'=>'form-control','div'=>'form-group'));
                        echo $this->Form->input('designation_id',array('class'=>'form-control','div'=>'form-group','options'=>$parentDesignations,'type'=>'select','empty'=>'select one'));
