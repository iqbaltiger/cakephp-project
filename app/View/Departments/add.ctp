		...
		<?php echo $this->Form->create('Department',array('role'=>'form','class'=>'')); ?>
            ...
            <div class="row-fluid">
                ...
                <div class="span4">
                    ...
                    <?php echo $this->Form->input('company_info_id',array('class'=>'form-control','div'=>'form-group','empty'=>'select one'));
                    
                    
			
			echo $this->Form->input('name',array('class'=>'form-control span4','div'=>'form-group'));?> 
