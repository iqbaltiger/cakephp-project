...
<div class="widget">
    ...
    $('#addMore').click(function(e){ //on add input button click
        ...
        if(x < max_fields){ //max input box allowed
            ...
            $(wrapper).append('<div><div class="span4">&nbsp;</div><input type="text" name="assigntask[]" class="span6" style="margin-left:-12px;"><a href="#" style="margin-left:25px;"class="remove_field icon-large icon-minus-sign btn btn-danger btn-sm btn-primary"></a></div>'); 
        }
    });
        ...
        e.preventDefault(); $(this).parent('div').remove(); x--;
                ...
                <div class='row-fluid'>
                    ...
                    <div id='recreate' class=''>
                            ...
                            <div class='span6'><input type="text" name='assigntask' class='span6'></div>
